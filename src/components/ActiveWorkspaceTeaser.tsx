    ...
    return (
        <div className="mt-10 p-8 rounded-2xl bg-gradient-to-br from-primary/90 to-primary text-white flex items-center justify-between shadow-xl shadow-primary/30">
            <div className="max-w-lg">
                ...
                <p className="text-primary-50 opacity-90 mb-6">Inicie uma nova sessão de estudos no Estúdio IA. Faça upload de qualquer arquivo ou link e obtenha análises instantâneas, flashcards e quizzes.</p>
